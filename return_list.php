...
<body>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="display: flex; align-items: center;">
                                                        <a href="#" class="btn btn-info btn-sm view-return-order" data-returnid="<?php echo htmlentities($row['id']); ?>" style="margin-right: 8px;"><span class="glyphicon glyphicon-search"></span> View </a>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title" id="productDetailsModalLabel"><b>Return Order Details</b></h4>
                                                </div>
    ...
    <script>
        $(document).ready(function() {
            $('.view-return-order').on('click', function(e) {
                e.preventDefault();
                var returnId = $(this).data('returnid');
                $.ajax({
                    url: 'return_view.php', // Ensure this is the correct path
                    method: 'POST',
                    data: {
                        id: returnId
                    },
    ...
    <script>
        function printOrderDetails() {
            ...
            // Additional styles
            printWindow.document.write('thead { background-color: #02964C; color: white; }');

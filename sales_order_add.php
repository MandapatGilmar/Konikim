    ...
    <div class="grid-container">
        ...
        <main class="main-container">
            <div class="main-title">
                <p class="font-weight-bold">SALES ORDER</p>
            </div>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                    ...
                    <div class="row" style="margin-top: 1%">
                        <div class="col-md-6">
                            ...
                            <a href="sales_orders.php" class="btn btn-success" style="background-color: #cc3c43; border-color: #cc3c43;"> View Sales Order List</a>
                        </div>
                    </div>
            </div>

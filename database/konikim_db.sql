...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2023 at 04:43 PM
...
INSERT INTO `inventory` (`id`, `product_id`, `supplier`, `productname`, `productunit`, `productattributes`, `productcategory`, `productprice`, `available_stocks`, `total`, `last_updated`) VALUES
(29, 31, 'Hard Copy ', 'Chipboard', 'Ream', '', '', 100.00, 20, 2000.00, '2023-12-15 13:51:00'),
(30, 29, 'Macro Paper Product ', 'Carbonless', 'Ream', '', '', 150.00, 25, 3750.00, '2023-12-15 13:51:03'),
(31, 28, 'Kraft Paper', 'Book Paper', 'Ream', '', '', 120.00, 20, 3000.00, '2023-12-15 13:51:05');
...
(28, 'PRD-00028', 0, 'Kraft Paper', 'Book Paper', 'Book 50', 'Size: 22 x 34', 'Ream', 120, '2023-12-15 05:14:53'),
(29, 'PRD-00029', 35, 'Macro Paper Product ', 'Carbonless', 'CB Top', 'Size: 8 1/2 x 11, GSM: 280', 'Ream', 150, '2023-12-15 05:16:23'),
(30, 'PRD-00030', 35, 'Macro Paper Product ', 'Conqueror', 'Bond Paper', 'Size: 22 x 34 ', 'Ream', 300, '2023-12-15 05:17:26'),
(31, 'PRD-00031', 36, 'Hard Copy ', 'Chipboard', '120 ', 'Size: 2120', 'Ream', 100, '2023-12-15 05:18:32');
...
(61, 'PO-00001', 'Hard Copy ', 2000.00, 0.00, 0.00, 0.00, 0.00, 2000.00, 1, '2023-12-15 05:51:00'),
(62, 'PO-00062', 'Macro Paper Product ', 3750.00, 0.00, 0.00, 0.00, 0.00, 3750.00, 1, '2023-12-15 05:51:03'),
(63, 'PO-00063', 'Kraft Paper', 3000.00, 0.00, 0.00, 0.00, 0.00, 3000.00, 1, '2023-12-15 05:51:05'),
(64, 'PO-00064', 'Kraft Paper', 840.00, 0.00, 0.00, 0.00, 0.00, 840.00, 0, '2023-12-15 07:21:07');
...
(76, 61, 31, 'Chipboard', 'Ream', 100.00, 'Size: 2120', '120 ', 20, 2000.00, 0.00, 0.00),
(77, 62, 29, 'Carbonless', 'Ream', 150.00, 'Size: 8 1/2 x 11, GSM: 280', 'CB Top', 25, 3750.00, 0.00, 0.00),
(78, 63, 28, 'Book Paper', 'Ream', 120.00, 'Size: 22 x 34', 'Book 50', 25, 3000.00, 0.00, 0.00),
(79, 64, 28, 'Book Paper', 'Ream', 120.00, 'Size: 22 x 34', 'Book 50', 7, 840.00, 0.00, 0.00);
...
(8, 'RC-00001', 'Hard Copy ', 500.00, '2023-12-15 08:53:46');
...
(7, 8, 31, 'Chipboard', 'Ream', 100.00, 'Size: 2120', '120 ', 5, 500.00);
...
CREATE TABLE `sales_orders` (
  ...
  `soSubtotal` decimal(10,2) NOT NULL,
  `soDiscount` decimal(5,2) NOT NULL,
  `soDiscountTotal` decimal(10,2) NOT NULL,
  `soTax` decimal(5,2) NOT NULL,
  `soTaxTotal` decimal(10,2) NOT NULL,
  `soGrandTotal` decimal(10,2) NOT NULL,
...
INSERT INTO `sales_orders` (`id`, `salescode`, `customername`, `soSubtotal`, `soDiscount`, `soDiscountTotal`, `soTax`, `soTaxTotal`, `soGrandTotal`, `dateCreated`) VALUES
(11, 'SALES-00001', 'Mike Bertiz', 600.00, 0.00, 0.00, 0.00, 0.00, 600.00, '2023-12-15 16:33:52');
...
INSERT INTO `sales_order_items` (`id`, `sales_order_id`, `product_id`, `productname`, `productunit`, `productquantity`, `productprice`, `productunitprice`) VALUES
(11, 11, 28, 'Book Paper', 'Ream', 5, 120.00, 600.00);
...
(34, 'Kraft Paper', 'Gilmar Mandapat', 9202672315, 'marmar.mandapat@gmail.com', 'Fortune ', '2023-12-15 05:10:05'),
(35, 'Macro Paper Product ', 'Khnei Emerie', 9202672315, 'Khnei@gmail.com', 'Sto. Nino Marikina City', '2023-12-15 05:10:53'),
(36, 'Hard Copy ', 'Virgilio Mandapat', 9202672315, 'virgilio@gmail.com', 'Parang Marikina City', '2023-12-15 05:11:48');
...
ALTER TABLE `sales_order_items`
  ...
  ADD KEY `sales_order_items_ibfk_2` (`product_id`);
...
ALTER TABLE `sales_order_items`
  ...
  ADD CONSTRAINT `sales_order_items_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `product_list` (`id`);
COMMIT;
